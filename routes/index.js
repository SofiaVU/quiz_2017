...
router.delete('/quizzes/:quizId(\\d+)/tips/:tipId(\\d+)', sessionController.loginRequired,tipController.adminOrAuthorTipRequired, tipController.destroy);

// Añado pagina jugar 
router.get('/quizzes/randomplay', quizController.randomPlay);
// pagina para comprobar 
